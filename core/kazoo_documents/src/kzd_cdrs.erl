...
col_reseller_id(JObj, _Timestamp, _Timezone) -> kz_json:get_value([?KEY_CCV, <<"reseller_id">>], JObj, <<>>).
col_account_id(JObj, _Timestamp, _Timezone) -> kz_json:get_value([?KEY_CCV, <<"account_id">>], JObj, <<>>).

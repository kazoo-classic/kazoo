...
%%% @doc Accessors for `queues' document.
%%% @end
%%%-----------------------------------------------------------------------------
-module(kzd_queues).
...
-export([breakout/1, breakout/2, set_breakout/2]).
-export([breakout_dtmf/1, breakout_dtmf/2, set_breakout_dtmf/2]).
-export([breakout_media/1, breakout_media/2, set_breakout_media/2]).
-export([breakout_media_call_back_at/1, breakout_media_call_back_at/2, set_breakout_media_call_back_at/2]).
-export([breakout_media_callback_registered/1, breakout_media_callback_registered/2, set_breakout_media_callback_registered/2]).
-export([breakout_media_enter_callback_number/1, breakout_media_enter_callback_number/2, set_breakout_media_enter_callback_number/2]).
-export([breakout_media_number_correct/1, breakout_media_number_correct/2, set_breakout_media_number_correct/2]).
-export([breakout_media_prompt/1, breakout_media_prompt/2, set_breakout_media_prompt/2]).
...
-spec breakout(doc()) -> kz_term:api_object().
breakout(Doc) ->
    breakout(Doc, 'undefined').

-spec breakout(doc(), Default) -> kz_json:object() | Default.
breakout(Doc, Default) ->
    kz_json:get_json_value([<<"breakout">>], Doc, Default).

-spec set_breakout(doc(), kz_json:object()) -> doc().
set_breakout(Doc, Breakout) ->
    kz_json:set_value([<<"breakout">>], Breakout, Doc).

-spec breakout_dtmf(doc()) -> kz_term:api_binary().
breakout_dtmf(Doc) ->
    breakout_dtmf(Doc, 'undefined').

-spec breakout_dtmf(doc(), Default) -> binary() | Default.
breakout_dtmf(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"dtmf">>], Doc, Default).

-spec set_breakout_dtmf(doc(), binary()) -> doc().
set_breakout_dtmf(Doc, BreakoutDtmf) ->
    kz_json:set_value([<<"breakout">>, <<"dtmf">>], BreakoutDtmf, Doc).

-spec breakout_media(doc()) -> kz_term:api_object().
breakout_media(Doc) ->
    breakout_media(Doc, 'undefined').

-spec breakout_media(doc(), Default) -> kz_json:object() | Default.
breakout_media(Doc, Default) ->
    kz_json:get_json_value([<<"breakout">>, <<"media">>], Doc, Default).

-spec set_breakout_media(doc(), kz_json:object()) -> doc().
set_breakout_media(Doc, BreakoutMedia) ->
    kz_json:set_value([<<"breakout">>, <<"media">>], BreakoutMedia, Doc).

-spec breakout_media_call_back_at(doc()) -> kz_term:api_binary().
breakout_media_call_back_at(Doc) ->
    breakout_media_call_back_at(Doc, 'undefined').

-spec breakout_media_call_back_at(doc(), Default) -> binary() | Default.
breakout_media_call_back_at(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"media">>, <<"call_back_at">>], Doc, Default).

-spec set_breakout_media_call_back_at(doc(), binary()) -> doc().
set_breakout_media_call_back_at(Doc, BreakoutMediaCallBackAt) ->
    kz_json:set_value([<<"breakout">>, <<"media">>, <<"call_back_at">>], BreakoutMediaCallBackAt, Doc).

-spec breakout_media_callback_registered(doc()) -> kz_term:api_binary().
breakout_media_callback_registered(Doc) ->
    breakout_media_callback_registered(Doc, 'undefined').

-spec breakout_media_callback_registered(doc(), Default) -> binary() | Default.
breakout_media_callback_registered(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"media">>, <<"callback_registered">>], Doc, Default).

-spec set_breakout_media_callback_registered(doc(), binary()) -> doc().
set_breakout_media_callback_registered(Doc, BreakoutMediaCallbackRegistered) ->
    kz_json:set_value([<<"breakout">>, <<"media">>, <<"callback_registered">>], BreakoutMediaCallbackRegistered, Doc).

-spec breakout_media_enter_callback_number(doc()) -> kz_term:api_binary().
breakout_media_enter_callback_number(Doc) ->
    breakout_media_enter_callback_number(Doc, 'undefined').

-spec breakout_media_enter_callback_number(doc(), Default) -> binary() | Default.
breakout_media_enter_callback_number(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"media">>, <<"enter_callback_number">>], Doc, Default).

-spec set_breakout_media_enter_callback_number(doc(), binary()) -> doc().
set_breakout_media_enter_callback_number(Doc, BreakoutMediaEnterCallbackNumber) ->
    kz_json:set_value([<<"breakout">>, <<"media">>, <<"enter_callback_number">>], BreakoutMediaEnterCallbackNumber, Doc).

-spec breakout_media_number_correct(doc()) -> kz_term:api_binary().
breakout_media_number_correct(Doc) ->
    breakout_media_number_correct(Doc, 'undefined').

-spec breakout_media_number_correct(doc(), Default) -> binary() | Default.
breakout_media_number_correct(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"media">>, <<"number_correct">>], Doc, Default).

-spec set_breakout_media_number_correct(doc(), binary()) -> doc().
set_breakout_media_number_correct(Doc, BreakoutMediaNumberCorrect) ->
    kz_json:set_value([<<"breakout">>, <<"media">>, <<"number_correct">>], BreakoutMediaNumberCorrect, Doc).

-spec breakout_media_prompt(doc()) -> kz_term:api_binary().
breakout_media_prompt(Doc) ->
    breakout_media_prompt(Doc, 'undefined').

-spec breakout_media_prompt(doc(), Default) -> binary() | Default.
breakout_media_prompt(Doc, Default) ->
    kz_json:get_binary_value([<<"breakout">>, <<"media">>, <<"prompt">>], Doc, Default).

-spec set_breakout_media_prompt(doc(), binary()) -> doc().
set_breakout_media_prompt(Doc, BreakoutMediaPrompt) ->
    kz_json:set_value([<<"breakout">>, <<"media">>, <<"prompt">>], BreakoutMediaPrompt, Doc).

...
%% @end
%%--------------------------------------------------------------------
-spec start_link(pid(), kapps_call:call(), kz_term:kz_proplist()) -> kz_term:startlink_ret().
...
%% @end
%%--------------------------------------------------------------------
-spec init(pid(), kapps_call:call(), kz_term:kz_proplist()) -> 'no_return'.
...
%% @end
%%--------------------------------------------------------------------
-spec get_config(kz_term:kz_proplist()) -> map().
get_config(Props) ->
...
%% @end
%%--------------------------------------------------------------------
-spec announcements_media(kz_term:kz_proplist()) -> kz_term:kz_proplist().
